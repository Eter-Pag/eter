    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="container py-16 px-4 max-w-6xl mx-auto">
        ...
        <section className="mt-16 bg-gradient-to-br from-purple-900 to-slate-900 rounded-3xl p-10 md:p-16 text-white shadow-2xl overflow-hidden relative">
          ...
          <div className="relative z-10 max-w-3xl">
            <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">IVE: El Legado de la Confianza</h3>
            <p className="text-lg text-slate-300 leading-relaxed mb-6">
              Desde su debut en 2021, IVE ha brillado con su talento, confianza y determinación de conquistar el mundo de la música. Han unido a millones de fans bajo un mismo nombre: DIVE.
            </p>
            <div className="flex flex-wrap gap-3">
              <Badge variant="outline" className="text-white border-white/20 px-3 py-1 text-sm">#IVE</Badge>
              <Badge variant="outline" className="text-white border-white/20 px-3 py-1 text-sm">#DIVE</Badge>
      ...
      <footer className="py-12 bg-white border-t border-slate-200 text-center">
        <div className="container px-4">
          ...
          <p className="text-slate-400 text-sm">© 2026 - Biografías Oficiales de IVE. Todos los derechos reservados.</p>
        </div>
      </footer>
    </div>
  );
