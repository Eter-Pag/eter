  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          { id: "rm", text: "Koala (tranquilo y sabio)" },
          { id: "jin", text: "Hámster (tierno y divertido)" },
          { id: "suga", text: "Gato (independiente y observador)" },
          { id: "jhope", text: "Ardilla (activa y energética)" },
          { id: "jimin", text: "Pollito (suave y cuidadoso)" },
          { id: "v", text: "Tigre o Oso (fuerte pero tierno)" },
          { id: "jk", text: "Conejo (rápido y adorable)" },
        ],
      },
      {
        id: 12,
        text: "¿Cuál es tu lugar ideal para vivir?",
        options: [
          { id: "rm", text: "Cerca de un museo o biblioteca" },
          { id: "jin", text: "Una casa grande con una cocina increíble" },
          { id: "suga", text: "Un estudio moderno y privado" },
          { id: "jhope", text: "Un lugar lleno de luz y color" },
          { id: "jimin", text: "Un apartamento acogedor en la ciudad" },
          { id: "v", text: "Una casa con estilo vintage y jardín" },
          { id: "jk", text: "Un lugar con espacio para mis hobbies" },
        ],
      },
      {
        id: 13,
        ...
        options: [
          { id: "rm", text: "Salgo a caminar o visito un parque" },
          { id: "jin", text: "Como algo delicioso o cuento chistes" },
          { id: "suga", text: "Me encierro a trabajar o dormir" },
          { id: "jhope", text: "Bailo o escucho música alegre" },
          { id: "jimin", text: "Hablo con alguien de confianza" },
          { id: "v", text: "Escucho música clásica o pinto" },
          { id: "jk", text: "Hago ejercicio intenso" },
        ],
      },
      {
        id: 14,
        text: "¿Cuál es tu mayor sueño?",
        options: [
          { id: "rm", text: "Dejar un legado positivo en el mundo" },
          { id: "jin", text: "Ser feliz y hacer felices a los demás" },
          { id: "suga", text: "Que mi música sea recordada por siempre" },
          { id: "jhope", text: "Ser una fuente de esperanza para todos" },
          { id: "jimin", text: "Ser la mejor versión de mí mismo" },
          { id: "v", text: "Vivir una vida llena de arte y amor" },
          { id: "jk", text: "Dominar todas las habilidades que me proponga" },
        ],
      },
      {
        id: 15,
        text: "¿Qué color te atrae más hoy?",
        options: [
          { id: "rm", text: "Azul profundo" },
          { id: "jin", text: "Rosa claro" },
          { id: "suga", text: "Negro o Blanco" },
          { id: "jhope", text: "Verde brillante" },
          { id: "jimin", text: "Amarillo suave" },
          { id: "v", text: "Púrpura o Marrón" },
          { id: "jk", text: "Rojo o Dorado" },
        ],
      }
    ],
  }
