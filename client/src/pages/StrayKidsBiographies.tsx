...
export default function StrayKidsBiographies() {
  ...
  const members = [
  {
    id: "bangchan",
    name: "Bang Chan",
    realName: "Christopher Bang / Bang Chan",
    position: "Líder, Productor, Vocalista, Bailarín, Rapero",
  ...
  },
  {
    ...
    position: "Bailarín Líder, Rapero Líder",
      ...
      <section className="relative h-[45vh] md:h-[60vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-end pb-12 text-white p-6 text-center">
          ...
          <p className="max-w-3xl text-lg md:text-2xl text-slate-200 font-medium leading-relaxed">
            Nueve talentos excepcionales que revolucionaron el K-Pop con su creatividad, energía y conexión única con sus fans.
          </p>
        </div>
      </section>
      ...
      <main className="container py-16 px-4 max-w-6xl mx-auto">
        ...
        <section className="mt-16 bg-gradient-to-br from-purple-900 to-slate-900 rounded-3xl p-10 md:p-16 text-white shadow-2xl overflow-hidden relative">
          ...
          <div className="relative z-10 max-w-3xl">
            <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">STRAY KIDS: El Legado de la Innovación</h3>
            <p className="text-lg text-slate-300 leading-relaxed mb-6">
              Desde su debut en 2018, Stray Kids ha revolucionado el K-Pop con su creatividad, energía y conexión única con sus fans. Han demostrado que la música es un puente sin fronteras que une a millones de personas bajo un mismo nombre: STAY.
            </p>
