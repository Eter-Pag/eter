      ...
      <section className="relative h-[45vh] md:h-[60vh] overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-end pb-12 text-white p-6 text-center">
          ...
          <p className="max-w-3xl text-lg md:text-2xl text-slate-200 font-medium leading-relaxed">
            El grupo femenino más influyente del mundo que redefinió el K-Pop global con su poder, estilo y presencia inigualable.
          </p>
        </div>
      </section>
      ...
      <main className="container py-16 px-4 max-w-6xl mx-auto">
        ...
        <section className="mt-16 bg-gradient-to-br from-purple-900 to-slate-900 rounded-3xl p-10 md:p-16 text-white shadow-2xl overflow-hidden relative">
          ...
          <div className="relative z-10 max-w-3xl">
            <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">BLACKPINK: El Legado de la Revolución</h3>
            <p className="text-lg text-slate-300 leading-relaxed mb-6">
              Desde su debut en 2016, BLACKPINK ha redefinido lo que significa ser un grupo de K-Pop global. Con su poder, elegancia y presencia inigualable, han conquistado el mundo y unido a millones de fans bajo un mismo nombre: BLINK.
            </p>
