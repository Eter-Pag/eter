  ...
  const sections = [
    {
      ...
      description: "Mantente al día con las últimas novedades, regresos y eventos de tus grupos favoritos.",
      path: "/noticias",
    ...
    },
    {
      icon: Store,
      title: "Tienda",
      description: "Explora nuestra colección de álbumes, mercancía oficial y más.",
      path: "/tienda",
      color: "from-blue-500 to-indigo-500",
      image: "/assets/imagentienda.png",
    },
    {
      icon: Images,
      title: "Galerías",
                ...
                <CardContent className="p-0 flex flex-col h-full">
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <Button
                      ...
                      className={`w-full gap-2 font-semibold px-6 h-11 rounded-lg transition-all ${
                        section.comingSoon
