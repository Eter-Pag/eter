            ...
            <CardContent className="p-0">
              ...
              <div className="p-3 md:p-6">
                <h2 className="text-base md:text-2xl font-bold mb-1 md:mb-2 flex items-center gap-2">
                  <Ticket className="size-4 md:size-5 text-blue-600" />
                  Rifa Activa
                </h2>
                <p className="text-gray-600 text-xs md:text-sm mb-2 md:mb-4 hidden md:block">
                  ¡Participa en nuestro sorteo vigente y gana premios increíbles!
                </p>
                <Button
                ...
                >
                  ...
                  <span className="hidden md:inline">Ver Rifa Vigente</span>
                  <span className="md:hidden">Rifa</span>
                </Button>
              </div>
            </CardContent>
          </Card>
